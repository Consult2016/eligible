...
libinput-dev libjpeg-dev libluajit-5.1-dev liblz4-dev libmount-dev \
...
uninstall_e23() {
  ...
  cd /usr/local/lib/*-linux-gnu/cmake
  sudo rm -rf Ecore*
  sudo rm -rf Edje*
  sudo rm -rf Eet*
  sudo rm -rf Eeze*
  ...
  cd /usr/local/lib/*-linux-gnu/pkgconfig
  sudo rm -rf ecore*
  sudo rm -rf ector*
  sudo rm -rf edje*
  sudo rm -rf eeze*
